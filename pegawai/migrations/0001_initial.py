# Generated by Django 4.1 on 2022-11-22 01:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_berkas', models.CharField(blank=True, db_column='nama', max_length=255, null=True)),
                ('status', models.IntegerField(choices=[('1', 'User'), ('2', 'Verifikasi'), ('3', 'Valid')], default=1)),
                ('keterangan', models.CharField(blank=True, db_column='nama_berkas', max_length=255, null=True)),
            ],
            options={
                'db_table': 't_berkas',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eselon', models.ForeignKey(db_column='id_eselon', default=53, max_length=32, on_delete=django.db.models.deletion.CASCADE, to='pegawai.teselon', verbose_name='Eselon')),
                ...
                ('unor', models.ForeignKey(db_column='Id_Unor', max_length=32, on_delete=django.db.models.deletion.CASCADE, to='pegawai.tunor')),
            ],
            options={
