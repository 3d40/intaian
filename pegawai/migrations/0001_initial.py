...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TKodeGolongan',
            fields=[
                ('kode_golongan', models.CharField(max_length=2, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tgl_lhr', models.CharField(blank=True, db_column='TGL_LHR', max_length=10, null=True)),
                ...
                ('tgl_sk_cpns', models.CharField(blank=True, db_column='TGL_SK_CPNS', max_length=10, null=True)),
                ('tmt_cpns', models.CharField(blank=True, db_column='TMT_CPNS', max_length=10, null=True)),
                ('nomor_sk_pns', models.CharField(blank=True, db_column='NOMOR_SK_PNS', max_length=50, null=True)),
                ('tgl_sk_pns', models.CharField(blank=True, db_column='TGL_SK_PNS', max_length=10, null=True)),
                ('tmt_pns', models.CharField(blank=True, db_column='TMT_PNS', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_jenis_jabatan', models.CharField(blank=True, db_column='NAMA_JENIS_JABATAN', max_length=27, null=True)),
                ('tahun', models.IntegerField(db_column='TAHUN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sk_tanggal', models.CharField(blank=True, db_column='Sk_Tanggal', max_length=14, null=True)),
                ('nomor_bkn', models.CharField(blank=True, db_column='Nomor_BKN', max_length=30, null=True)),
                ('tanggal_bkn', models.CharField(blank=True, db_column='Tanggal_BKN', max_length=14, null=True)),
                ('tmt_golongan', models.CharField(blank=True, db_column='TMT_Golongan', max_length=14, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(db_column='ID', max_length=32, primary_key=True, serialize=False)),
                ('nip', models.CharField(db_column='NIP', max_length=18)),
                ('nama', models.CharField(db_column='Nama', max_length=40)),
                ('id_jabatan', models.CharField(blank=True, db_column='Id_Jabatan', max_length=32, null=True)),
                ('id_eselon', models.IntegerField(blank=True, db_column='Id_Eselon', null=True)),
                ('eselon', models.CharField(blank=True, db_column='Eselon', max_length=5, null=True)),
                ('tmt_jabatan', models.CharField(db_column='TMT_Jabatan', max_length=14)),
                ('nomor_sk', models.CharField(blank=True, db_column='Nomor_SK', max_length=52, null=True)),
                ('tanggal_sk', models.CharField(blank=True, db_column='Tanggal_SK', max_length=14, null=True)),
                ('id_satuan_kerja', models.CharField(db_column='Id_Satuan_Kerja', max_length=32)),
                ('tmt_pelantikan', models.CharField(blank=True, db_column='TMT_Pelantikan', max_length=14, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TUnor',
            fields=[
                ('unor_id', models.CharField(db_column='UNOR_ID', max_length=32, primary_key=True, serialize=False)),
                ...
                ('unor_order', models.IntegerField(blank=True, db_column='UNOR_ORDER', null=True)),
                ...
                ('induk_unor_id', models.CharField(blank=True, db_column='INDUK_UNOR_ID', max_length=32, null=True)),
            ],
            options={
                'db_table': 't_unor',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pns_id', models.CharField(db_column='PNS_ID', max_length=32)),
            ],
            options={
                'db_table': 't_user',
                'managed': False,
